...
//metemos todos los productos ofrecidos en esta variable
const productosOfrecidos = document.querySelector('.contenedor-productos-ofrecidos')

let productosFinalesSeleccionados = []

// Al cargar la página, intenta cargar los productos desde SessionStorage
document.addEventListener('DOMContentLoaded', () => {
    cargarProductosDesdeLocalStorage();
});

function cargarProductosDesdeLocalStorage() {
    const carritoGuardado = sessionStorage.getItem('productosFinalesSeleccionados');
    if (carritoGuardado) {
        console.log("dentro");
        console.group(carritoGuardado);
        productosFinalesSeleccionados = JSON.parse(carritoGuardado);
...
//si productosOfrecidos existe, esto solo sera verdadero si estamos en la pagina principal
//donde se muestran los productos
if(productosOfrecidos){
//si cuando se hace click en donde estan todos los productos, el elemento donde se haga
//click tiene la clase btn-agregar-carrito, significa que se hizo click en el boton
...
productosOfrecidos.addEventListener('click', e => {
    ...
    if (e.target.classList.contains('btn-agregar-carrito')){
        ...
        //obtenemos el elemento padre de(btn-agregar-carrito)
        //que es el div llamado info-producto-ofrecido que tiene
        //el producto completo, y lo metemos en la variable producto
        ...
        // Guardamos los productos seleccionados en el sessionStorage para usarlo en otra pagina a esos datos 
        sessionStorage.setItem('productosFinalesSeleccionados', JSON.stringify(productosFinalesSeleccionados));
